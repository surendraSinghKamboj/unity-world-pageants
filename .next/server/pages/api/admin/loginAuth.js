...
const handler = async (req, res)=>{
    if (req.method === "POST") {
        ...
        try {
            ...
            if (token) {
                const cookieSerialized = cookie__WEBPACK_IMPORTED_MODULE_4___default().serialize("adminToken", token, {
                    httpOnly: true,
                    maxAge: 43200000,
                    path: "/"
                });
...
var __webpack_exports__ = __webpack_require__.X(0, [5132], () => (__webpack_exec__(4724)));
