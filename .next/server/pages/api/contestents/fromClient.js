...
const handler = async (req, res)=>{
    if (req.method === "POST") {
        ...
        try {
            ...
            if (result) {
                const response = await _models_contestants__WEBPACK_IMPORTED_MODULE_1__/* ["default"].create */ .Z.create({
                    name,
                    title,
                    age,
                    occupation,
...
var __webpack_exports__ = __webpack_require__.X(0, [5132,8550,3412], () => (__webpack_exec__(4363)));
