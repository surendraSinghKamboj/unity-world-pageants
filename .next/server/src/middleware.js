...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_js_page_2Fsrc_2Fmiddleware_rootDir_D_3A_5Cinternship_5Cunity_world_pageants_matchers_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.js&page=%2Fsrc%2Fmiddleware&rootDir=D%3A%5Cinternship%5Cunity-world-pageants&matchers=!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_js_page_2Fsrc_2Fmiddleware_rootDir_D_3A_5Cinternship_5Cunity_world_pageants_matchers_(opts) {
          return adapter({
              ...opts,
              page: "/src/middleware",
              handler,
...
function middleware(req) {
    ...
    if (pathname.startsWith("/Dashboard")) {
        ...
        if (!adminToken) {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(`${process.env.DOMAIN_NAME}/admin`);
        }
    } else if (pathname.startsWith("/admin")) {
        if (adminKey !== process.env.ADMIN_KEY) {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(`${process.env.DOMAIN_NAME}`);
        }
        const adminToken = req.cookies.get("adminToken")?.value;
        if (adminToken) {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(`${process.env.DOMAIN_NAME}/Dashboard`);
        }
    }
